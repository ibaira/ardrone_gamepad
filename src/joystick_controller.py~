...
def togglecam_client():
    ...
    try:
        ...
        print "Service togglecam call failed: %s"%e
...
def flattrim_client():
    ...
    try:
        ...
        print "Service flattrim call failed: %s"%e
...
def ReceiveJoystickMessage(data):
	if data.buttons[ButtonEmergency]==1:
		...
		rospy.loginfo("Change Camera Button Pressed")
		togglecam_client()
